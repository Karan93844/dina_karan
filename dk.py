...
if st.button("Generate ✨"):
    ...
    with col_text, st.spinner("Writing..."):
        try:
            # Passing model directly into the client securely fixes routing errors
            client_text = InferenceClient(model="meta-llama/Meta-Llama-3-8B-Instruct", token=hf_token)
